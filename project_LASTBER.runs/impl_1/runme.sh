...
HD_PWD='C:/Users/Monster/Desktop/project_LASTBER/project_LASTBER.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topDesign.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topDesign.tcl -notrace
